    ...
    <Drawer.Content>
        <div class="w-full max-h-[450px] flex flex-col items-center justify-center p-4 font-kalam">
            <div class="max-w-[450px] w-full">
                ...
                <div class="mt-4">
                    <Label for="name" class="{form?.errors?.name ? labelErrorClass : ''}">Namn</Label>
                    <Input type="text" id="name" name="name" class="{form?.errors?.name ? inputErrorClass : ''}" placeholder="Namn" on:keydown={() => nameError = false} bind:value={name} on:click={giveFocus} />
                ...
                <div class="mt-4">
                    <Label for="amount" class="{form?.errors?.amount ? labelErrorClass : ''}">Antal</Label>
                    <Input type="number" id="amount" name="amount" class="{form?.errors?.amount ? inputErrorClass : ''}" placeholder="Antal" on:keydown={() => amountError = false} bind:value={amount} />
                </div>
